...
int main(void)
{
	...
	*p= -3;
	...
	p = &x;
	p->apont= &y;
	printf("\n \'&p\' (endereço de \'p\'): %016lX \n", (uintptr_t)&p);	
	printf("\n \'p\' (conteudo de \'p\'): %016lX \n", (uintptr_t)p);	
	...
	printf("\n endereço de \'y\':%016lX \n", (uintptr_t)&y);
	printf("\n endereço de \'p\': %016lX \n", (uintptr_t)&p);	
	printf("\n endereço de \'pp\': %016lX \n", (uintptr_t)&pp);
	printf("\n \'p\' aponta para: %016lX \n", (uintptr_t)p);	
	printf("\n \'pp\' aponta para: %016lX \n", (uintptr_t)pp);	
	...
	*pp = &y;
	printf("\n Alterando o endereço apontado por \'p\' por meio de \'*pp\' = &y == %016lX \n", (uintptr_t)&y);
	...
	**pp = 137;
	...
	printf("\n \'p\' aponta para a struct no endereco: %016lX \n", (uintptr_t)p);
	printf("\n endereço de \'p->nome\': %016lX \n", (uintptr_t) &(p->nome));
	printf("\n endereço de \'p->idade\': %016lX \n", (uintptr_t)&(p->idade));
	printf("\n ================= FIM TESTE %i \n\n",TEST);
	...
	aux1=lista;	
	while(aux1 != NULL)
	{	printf("\n \'aux1\' aponta para: %016lX --- nome: %s, idade: %i \n", (uintptr_t)aux1, aux1->nome, aux1->idade);
		aux1=aux1->link;
	}
	printf("\n TECLE \n");	
	getchar();
